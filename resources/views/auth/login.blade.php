    ...
    <div class="flex flex-col justify-center flex-1 w-full max-w-md mx-auto">
        <div>
            <div class="mb-5 sm:mb-8">
                ...
                <p class="text-sm text-gray-500 dark:text-gray-400">Entre com suas credenciais para acessar o sistema!</p>
            </div>
            <div>
                ...
                @csrf
                    ...
                    <!-- Email -->
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <a href="{{ route('password.request') }}" class="text-sm text-gray-500 hover:text-gray-600 dark:text-white/60">Esqueceu a senha?</a>
                        </div>
                        <!-- Button -->
                        <div>
