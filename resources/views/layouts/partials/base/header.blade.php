    ...
    <div class="flex grow flex-col items-center justify-between lg:flex-row lg:px-6">
        <div
            ...
            <a href="{{ route('dashboard') }}" class="lg:hidden">
                <img class="dark:hidden h-12" src="{{ asset('assets/images/logo/logo.svg') }}" alt="Logo" />
                <img class="hidden dark:block h-12" src="{{ asset('assets/images/logo/logo-dark.svg') }}"
                    alt="Logo" />
            </a>
        ...
        <div :class="menuToggle ? 'flex' : 'hidden'"
            ...
            <div class="2xsm:gap-3 flex items-center gap-2">
                ...
                @include('layouts.partials.base.notifications')
            </div>
            ...
            <div class="relative" x-data="{ dropdownOpen: false }" @click.outside="dropdownOpen = false">
                <a class="flex items-center text-gray-700 dark:text-gray-400" href="#"
                    ...
                    <span class="mr-3 h-11 w-11 overflow-hidden rounded-full">
                        <img src="https://ui-avatars.com/api/?name={{ urlencode(Auth::user()->firstname . ' ' . Auth::user()->lastname ?? 'User') }}" alt="avatar">
                    </span>
                ...
                <div x-show="dropdownOpen"
                    ...
                    dark:hover:text-white">
                                    <svg class="fill-white group-hover:fill-white dark:group-hover:fill-white"
                                        width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path fill-rule="evenodd" clip-rule="evenodd"
