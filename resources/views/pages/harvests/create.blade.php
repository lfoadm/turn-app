<x-app-layout>
    <div class="mx-auto max-w-[1440px] p-4 md:p-6">
        <!-- Breadcrumb / Título -->
        <div x-data="{ pageName: `Criando nova safra`}" class="px-3 py-2">
        ...
        <div class="rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
            ...
            <div class="border-t border-gray-100 p-5 dark:border-gray-800 sm:p-6">
                ...
                <div x-data="dataTable()" class="overflow-hidden rounded-xl border border-gray-200 bg-white pt-4 dark:border-gray-800 dark:bg-white/[0.03]">
                    ...
                    <!-- Formulario -->
                        <form action="{{ route('harvests.store') }}" method="POST" class="space-y-6 m-6">
                            @csrf
                            ...
                            <div>
                                ...
                                <label x-data="{ active: {{ old('is_active', $model->is_active ?? false) ? 'true' : 'false' }} }" 
