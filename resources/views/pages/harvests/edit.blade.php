                    ...
                    <form action="{{ route('harvests.update', $harvest) }}" method="POST" class="space-y-6 m-6">
                        ...
                        <div>
                            ...
                            <x-text-input id="title" name="title" type="text"
                                value="{{ old('title', $harvest->title) }}" required autofocus
                        ...
                        <div>
                            ...
                            <label x-data="{ active: {{ old('is_active', $harvest->is_active) ? 'true' : 'false' }} }"
                                ...
                                <input type="checkbox" id="is_active" name="is_active" value="1"
                                    class="sr-only peer" x-model="active">
                                ...
                                <span x-show="active"
                                    class="ml-3 text-sm font-medium text-green-600 dark:text-green-400">Ativa</span>
                                <span x-show="!active"
                                    class="ml-3 text-sm font-medium text-red-600 dark:text-red-400">Inativa</span>
                            </label>
                        </div>
