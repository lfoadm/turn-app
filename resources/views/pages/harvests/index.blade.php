                ...
                <div x-data="dataTable()" class="overflow-hidden rounded-xl border border-gray-200 bg-white pt-4 dark:border-gray-800 dark:bg-white/[0.03]">
                    ...
                    <div class="mb-4 flex flex-col gap-2 px-4 sm:flex-row sm:items-center sm:justify-between">
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <select x-model.number="perPage" class="dark:bg-dark-900 h-9 w-full rounded-lg border border-gray-300 text-sm text-gray-800 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90">
                        ...
                        <div class="relative mt-2 sm:mt-0">
                            <input type="text" x-model="search" placeholder="Pesquisar..." class="dark:bg-dark-900 h-11 w-full rounded-lg border border-gray-300 py-2.5 pl-3 pr-4 text-sm text-gray-800 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30">
                        </div>
                    </div>
                    ...
                    <div class="max-w-full overflow-x-auto">
                        <div class="min-w-[600px]">
                            ...
                            <div class="grid grid-cols-12 border-t border-gray-200 dark:border-gray-800">
                                ...
                                <div class="col-span-4 flex justify-between items-center px-4 py-3 cursor-pointer" @click="sortBy('is_active')">
                            ...
                            <template x-for="person in paginatedData" :key="person.id">
                                <div class="grid grid-cols-12 border-t border-gray-100 dark:border-gray-800">
                                    ...
                                    <div class="col-span-4 flex items-center px-4 py-3">
                                        <span
                                            x-text="person.is_active"
                                            :class="person.is_active === 'ATIVA' 
                                                ? 'bg-green-100 text-green-800 dark:bg-green-700 dark:text-green-100' 
                                                : 'bg-red-100 text-red-800 dark:bg-red-700 dark:text-red-100'"
                                            class="inline-flex items-center px-3 py-1 rounded-full text-sm font-semibold transition-colors duration-200"
                                        ></span>
                                    </div>
                                    <div class="col-span-4 flex items-center justify-center px-4 py-3 gap-2">
                                        <!-- Botão Editar -->
                                        {{-- <a :href="`/admin/harvests/${person.id}/edit`" class="px-3 py-1 text-sm font-medium text-cyan-600 hover:text-cyan-900 dark:text-gray-300 dark:hover:text-cyan-300"> --}}
                                        <a :href="`{{ route('harvests.edit', ':id') }}`.replace(':id', person.id)" class="px-3 py-1 text-sm font-medium text-cyan-600 hover:text-cyan-900 dark:text-gray-300 dark:hover:text-cyan-300">
                    ...
                    <div class="border-t border-gray-200 py-4 px-3 dark:border-slate-800">
                        <div class="flex flex-col items-center justify-between gap-4 sm:flex-row">
                            <p class="text-sm text-gray-600 dark:text-gray-400">
                                Mostrando <span class="font-bold" x-text="startEntry"></span> a <span class="font-bold" x-text="endEntry"></span> de <span class="font-bold" x-text="totalEntries"></span> registros
                            </p>
