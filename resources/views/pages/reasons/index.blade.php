...
<x-app-layout>
    <div class="mx-auto max-w-[1440px] p-4 md:p-6">
        <!-- Breadcrumb / Título -->
        <div x-data="{ pageName: `Motivos de parada`}" class="px-3 py-2">
        ...
        <div class="rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
            ...
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between my-4 px-4" 
                x-data="{ 
                    buttonText: '+ Motivo',
                    buttonRoute: '{{ route('reasons.create') }}',
                }"
            >
                <h3 class="text-base font-medium text-gray-800 dark:text-white/90 mb-2 sm:mb-0">
                    🛑 Lista de motivos de paradas na operação de carregamento ferroviário
                </h3>
                <x-button></x-button>
            </div>
                    ...
                    <div class="max-w-full overflow-x-auto">
                        <div class="min-w-[600px]">
                            ...
                            <div class="grid grid-cols-12 border-t border-gray-200 dark:border-gray-800">
                                ...
                                <div class="col-span-4 flex justify-between items-center px-4 py-3 cursor-pointer" @click="sortBy('purge')">
                                    <p class="text-theme-xs font-medium text-gray-700 dark:text-gray-400">Expurga?</p>
                                    <span class="flex flex-col gap-0.5">
                                        <svg class="fill-gray-600 dark:fill-gray-200" width="8" height="5" viewBox="0 0 8 5" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M4.40962 0.585167C4.21057 0.300808 3.78943 0.300807 3.59038 0.585166L1.05071 4.21327C0.81874 4.54466 1.05582 5 1.46033 5H6.53967C6.94418 5 7.18126 4.54466 6.94929 4.21327L4.40962 0.585167Z" fill=""></path>
                                        </svg>
                            ...
                            <template x-for="person in paginatedData" :key="person.id">
                                <div class="grid grid-cols-12 border-t border-gray-100 dark:border-gray-800">
                                    ...
                                    <div class="col-span-4 flex items-center justify-center px-4 py-3 gap-2">
                                        <!-- Botão Editar -->
                                        <a :href="`/reasons/${person.id}/edit`" class="px-3 py-1 text-sm font-medium text-cyan-600 hover:text-cyan-900 dark:text-gray-300 dark:hover:text-cyan-300">
