...
<x-app-layout>
    <div class="mx-auto max-w-[1440px] p-4 md:p-6">
        <!-- Breadcrumb / Título -->
        <div x-data="{ pageName: `Usuários pendentes` }" class="px-3 py-2">
        ...
        <div class="rounded-2xl border border-gray-200 bg-white dark:border-gray-700 dark:bg-white/[0.03]">
            ...
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between my-4 px-4" x-data="{
                ...
                <h3 class="text-base font-medium text-red-600 dark:text-red-400 mb-2 sm:mb-0">
                    ⏳ Usuários aguardando aprovação
                </h3>
            </div>

            <div class="border-t border-gray-100 p-5 dark:border-gray-700 sm:p-6">
                ...
                <div x-data="dataTable()"
                    ...
                    <div class="max-w-full overflow-x-auto">
                        <div class="min-w-[600px]">
                            ...
                            <!-- Table Header -->
                            <div class="grid grid-cols-12 border-t border-gray-200 dark:border-gray-700">
                                ...
                                <div class="col-span-3 flex justify-between items-center border-r border-gray-200 px-4 py-3 dark:border-gray-700 cursor-pointer"
                                    ...
                                    <p class="text-theme-xs font-medium text-gray-700 dark:text-gray-400">Sobrenome</p>
                                    <span class="flex flex-col gap-0.5">
                                        <svg class="fill-gray-600 dark:fill-gray-200" width="8" height="5"
                                            viewBox="0 0 8 5" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path
                                ...
                                <div class="col-span-2 flex justify-between items-center border-r border-gray-200 px-4 py-3 dark:border-gray-700 cursor-pointer"
                                    @click="sortBy('phone')">
                                    <p class="text-theme-xs font-medium text-gray-700 dark:text-gray-400">Celular</p>
                                    <span class="flex flex-col gap-0.5">
                                        <svg class="fill-gray-600 dark:fill-gray-200" width="8" height="5"
                                            viewBox="0 0 8 5" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path
                                ...
                                <div class="col-span-1 flex items-center justify-center px-4 py-3">
                                    <p class="text-theme-xs font-medium text-gray-700 dark:text-gray-400">Grupo usuários</p>
                                </div>
                                <div class="col-span-1 flex items-center justify-center px-4 py-3">
                            ...
                            <template x-for="person in paginatedData" :key="person.id">
                                <div class="grid grid-cols-12 border-t border-gray-100 dark:border-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600">
                                    ...
                                    <div class="col-span-3 flex items-center px-4 py-3">
                                        <span x-text="person.lastname" class="text-center justify-center text-theme-xs block font-xs text-gray-800 dark:text-white/90"></span>
                                    </div>
